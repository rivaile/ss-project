...
public class PageResponse<T> implements Serializable {
    ...
    public static <T> PageResponse<T> success(String message) {
        PageResponse<T> rsp = new PageResponse<>();
     ...
     * @param result 返回内容
     */
    public static <T> PageResponse<T> success(List<T> result) {
        PageResponse<T> rsp = new PageResponse<>();
        rsp.setCode(ReturnCode.SUCCESS);
        rsp.setData(result);
        return rsp;
     ...
     * @param result 返回内容
     */
    public static <T> PageResponse<T> success(ReturnCode code, List<T> result) {
        PageResponse<T> rsp = new PageResponse<>();
        rsp.setSuccess(true);
        rsp.setCode(code);
        rsp.setData(result);
     ...
     * @param message 响应消息
     */
    public static <T> PageResponse<T> success(List<T> result, String message) {
        PageResponse<T> rsp = new PageResponse<>();
        rsp.setCode(ReturnCode.SUCCESS);
        rsp.setMsg(message);
        rsp.setData(result);
     ...
     * @return 响应对象
     */
    public static <T> PageResponse<T> withCode(ReturnCode code, Object... args) {
        PageResponse<T> rsp = new PageResponse<>();
     ...
     * @return 404 响应对象
     */
    public static <T> PageResponse<T> notFound(String message) {
        PageResponse<T> rsp = new PageResponse<>();
     ...
     * @return 响应对象
     */
    public static <T> PageResponse<T> badRequest(String message) {
        PageResponse<T> rsp = new PageResponse<>();
     ...
     * @return 错误响应对象
     */
    public static <T> PageResponse<T> error(ReturnCode code, String errMsg) {
        PageResponse<T> rsp = withCode(code);
        rsp.setError(errMsg);
        return rsp;
    }
